...
function setAccessFlags() {
	var accessFlags = classContents[CPSIZE+5].toString(16) + 
	classContents[CPSIZE+6].toString(16);
	console.log(accessFlags);
	var wordFlags = '';
...
function setThisClass() {
	var thisClass = classContents[CPSIZE+4].toString(16) + 
...
function setSuperClass() {
	var superClass = classContents[CPSIZE+6].toString(16) + 
...
function setInterfacesCount() {
	var interfacesCount = classContents[CPSIZE+10].toString(16) +
	classContents[CPSIZE+12].toString(16);
