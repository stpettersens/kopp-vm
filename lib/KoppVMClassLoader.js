...
function setAccessFlags() {
	var accessFlags = classContents[154].toString(16) +
	classContents[155].toString(16);
...
function setThisClass() {
	var thisClass = classContents[156].toString(16) +
	classContents[157].toString(16);
...
function setSuperClass() {
	var superClass = classContents[158].toString(16) +
	classContents[159].toString(16);
