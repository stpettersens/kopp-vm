...
function setAccessFlags() {
	CPSIZE = CPSIZE - 13;
	var accessFlags = classContents[CPSIZE].toString(16) +
	classContents[CPSIZE+1].toString(16);
	console.log('CPSIZE = ' + CPSIZE);
	console.log('accessFlags P1: ' + classContents[154].toString(16));
	console.log('accessFlags P2: ' + classContents[155].toString(16));
...
function setThisClass() {
	var thisClass = classContents[CPSIZE+2].toString(16) +
	classContents[CPSIZE+3].toString(16);
...
function setSuperClass() {
	var superClass = classContents[CPSIZE+4].toString(16) +
	classContents[CPSIZE+5].toString(16);
