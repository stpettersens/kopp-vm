...
/**
 * Return number of parameters a word mnemonic instruction takes.
 * @param {string} instruction Word mnemonic instruction.
 * @returns {integer} params Number of parameters the instruction takes.
*/
function getInstructionParams(instruction) {
	var params = bc.BytecodeWParams[instruction];
	return params;
}
